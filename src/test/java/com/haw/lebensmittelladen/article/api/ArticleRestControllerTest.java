...
class ArticleRestControllerTest {
    ...
    void setUp() {
        ...
        article = articleRepository.save(new Article(new Barcode(), "Banane", "Edeka Bio Banane", "Edeka", 1.55, 1));
        articleRepository.save(new Article(new Barcode(), "Kirsche", "Edeka Bio Kirsche", "Edeka", 2.44, 2));
